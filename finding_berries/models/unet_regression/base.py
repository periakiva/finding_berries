...
class SegmentationModel(torch.nn.Module):
    ...
    def initialize(self):
        ...
        # self.count_branch = nn.Sequential(nn.Linear(38*28*512,64),
        #                                 nn.LeakyReLU(inplace=True),
        #                                 nn.Dropout(p=0.5))
        # self.branch_2 = nn.Sequential(nn.Linear(456*608*2,64),
    ...
    def forward(self, x):
        ...
        # print(features)
        # x_nonlin = self.out_nonlin(decoder_output)
        # x_flat = x_nonlin.view(1,-1)
        # mid_layer_flat = features.view(1,-1)
